#!/usr/bin/env python3
"""
05c - Apply OCEAN Weights to All Customers
"""
...
print("\n" + "="*100)
print("05c - APPLY OCEAN WEIGHTS TO ALL CUSTOMERS")
print("="*100 + "\n")
...
try:
    ...
    print("❌ Error: ocean_ridge_models.pkl not found!")
    sys.exit(1)
...
print("\n" + "="*100)
print("ALL OCEAN PIPELINE STEPS (05a, 05b, 05c) COMPLETED SUCCESSFULLY!")
print("="*100)

print("\nGenerated files:")
print("  ✅ ocean_ground_truth_500.csv      - 500 labeled samples with OCEAN scores")
print("  ✅ ocean_ridge_models.pkl          - Trained Ridge regression models")
print("  ✅ ocean_weights_formula.json      - Weight coefficients in JSON format")
print("  ✅ ocean_features.csv              - OCEAN scores for all 123K+ customers")
print("  ✅ loan_clean_with_ocean.csv       - Complete dataset with OCEAN features")

print("\nNext steps:")
print("  1. Run 04_xgboost_baseline.ipynb (baseline without OCEAN)")
print("  2. Run 06_xgboost_with_ocean.ipynb (model with OCEAN features)")
print("  3. Run 07_results_analysis.ipynb (compare performance)")
