#!/usr/bin/env python3
"""
Execute OCEAN Pipeline Notebooks Sequentially
This script extracts and runs code from Jupyter notebooks in the correct order
"""
...
def main():
    """Main execution"""
    print("\n" + "="*100)
    print("OCEAN PIPELINE EXECUTION")
    print("="*100)

    # Define execution order
    notebooks = [
        ('05a_llm_ocean_ground_truth.ipynb', '05a - LLM Ground Truth Generation'),
        ('05b_train_ocean_ridge_weights.ipynb', '05b - Train Ridge Regression Weights'),
        ('05c_apply_ocean_to_all.ipynb', '05c - Apply OCEAN Formula to All Customers'),
        ...
        ('notebooks/04_results_analysis/07_results_analysis.ipynb', '07 - Results Analysis'),
    ]
    ...
    for notebook_path, description in notebooks:
        ...
        if 'ocean' in notebook_path.lower() and not success:
            print("\n⚠️ OCEAN pipeline execution failed, stopping...")
            break
