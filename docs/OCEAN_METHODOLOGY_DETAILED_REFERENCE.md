...
**Ground Truth生成**:
- 样本量：500（250 Fully Paid + 250 Charged Off）
- 生成方法：5个LLM通过HuggingFace Inference API
- 数据文件：`ocean_ground_truth/[llm]_ocean_500.csv`
...
| 路线 | 方法 | Ground Truth | 样本需求 | 预期R² | 成本 | 推理速度 | 状态 |
|-----|------|-------------|---------|--------|------|---------|------|
| 1 | Ridge-Weighted | ✅ | 500 | 0.15-0.20 | $0 | <1ms | ✅ 完成 |
| 2A | BGE + Elastic Net | ✅ | 500 | 0.19-0.24 | $0 | 50ms | ✅ 完成 |
| 2B | MPNet-Base-v2 + Elastic Net | ✅ | 500 | 0.25-0.35 | $0 | 100ms | 🔨 待做 |
| 2C | MPNet-Base-v2 + 高级回归 | ✅ | 500-800 | 0.30-0.40 | $0 | 100ms | ⏸️ 可选 |
| 3A | Cross-Encoder Zero-Shot | ✅ | 500 | 0.20-0.35? | $0 | 200ms | 🔨 待做 |
| 3B | Cross-Encoder微调 | ✅ | 500 | 0.40-0.60 | $50-75 | 200ms×25 | ⏸️ 备选 |
